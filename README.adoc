...
== Purpose
include::docs/Purpose.adoc[]

== AEM Support
include::docs/AEM_Support.adoc[]
...
== Releasing
For the Grabbit developers, link:docs/RELEASING.adoc[instructions for releasing a new version of Grabbit].

== Library Attribution
include::docs/LibraryAttribution.adoc[]

== LICENSE
include::docs/LicenseInfo.adoc[]
